...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "D1C40"  # Playfab Title Id
        self.SecretKey: str = "EM6JQHHX8CENUDGNPGMQW5F11BNJ9BNIR3YTM1KQJH8I3S5N6E"  # Playfab Secret Key
        self.ApiKey: str = "OC|1199457816584735|f4d4ab3b5fbcedf94cbbc468640aa9ad"  # App Api Key (Oculus/Graph API)
...
def titledata():
    response_data = {
        ...
        "MOTD": "<color=#FFC0CB>WELCOME TO SPRINTING GORILLAS!</color>\n\n<color=#0099c2>CURRENT UPDATE: CANT SEA ME24</color>\n<color=#cacfd2>OWNERS: ZENON, GOOB</color>\n<color=#41ff80>ZENON MADE THIS MOTD</color>\n<color=#6417ff>OUR DEVELOPERS ARE: ZENON</color>\n<color=#ac1a00>MOD APPS ARE GONNA BE OPEN SOON!</color>\n\n<color=#91A3B0>discord.gg/JvDabXYFXK</color>",
